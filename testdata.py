...
# 1. Stores
stores = [
        Store(id=1,name='ドラゴンボール',open_hours=16,close_hours=24),
        Store(id=2,name='ワンピース',open_hours=17,close_hours=24),
        Store(id=3,name='呪術廻戦',open_hours=16,close_hours=25),
        Store(id=4,name='鬼滅の刃',open_hours=17,close_hours=25)
]
db.add_all(stores)
